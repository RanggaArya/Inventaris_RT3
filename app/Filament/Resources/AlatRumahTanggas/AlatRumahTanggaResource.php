...
class AlatRumahTanggaResource extends Resource
{
    ...
    protected static string|UnitEnum|null $navigationGroup = 'Inventaris Rumah Tangga';

    protected static ?string $recordTitleAttribute = 'nama_perangkat';
    protected static ?string $modelLabel = 'Alat Rumah Tangga';
    protected static ?string $pluralModelLabel = 'List Perangkat';
