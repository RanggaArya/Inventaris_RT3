    ...
    <div class="border-b border-gray-200 bg-gray-50 px-6 py-4 dark:border-gray-800 dark:bg-gray-800/50 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">
                Inventaris: <span class="font-mono font-semibold text-primary-600 dark:text-primary-400">{{ $record->nomor_inventaris ?? '-' }}</span>
                &bull; Tipe: {{ $record->tipe ?? '-' }}
            </p>
        </div>
            ...
            <div class="space-y-3">
                ...
                <div class="flex items-center gap-2 mt-4 pt-2">
                    ...
                    <div class="text-xs text-gray-500">
                        <p>Dibuat oleh: <span class="font-medium text-gray-700 dark:text-gray-300">{{ $record->user->name ?? '-' }}</span></p>
