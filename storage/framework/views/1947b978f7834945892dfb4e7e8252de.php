<div class="w-full">
  <form wire:submit="authenticate" class="space-y-6 w-full">
    <div class="flex items-center gap-4 pb-2">
      <img src="<?php echo e(asset('img/rsumpyk.png')); ?>" class="w-12 h-12 rounded-2xl border border-white/10 dark:border-white/10">
      ...
      <div class="leading-tight">
        ...
        <p class="text-sm text-slate-600 dark:text-white/70">
          Sistem Pencatatan Inventaris & Maintenance Alat Kesehatan
        </p>
      </div>
    </div>
...
<?php /**PATH E:\Magang\Inventaris AlKes\inventory-alkes\resources\views/filament/pages/login.blade.php ENDPATH**/ ?>