...
<head>
    ...
    <title>Detail Perangkat: <?php echo e($perangkat->nama_perangkat); ?></title>
...
<body class="bg-gray-100">
    ...
    <main class="p-4 sm:p-8">
        <div class="max-w-3xl mx-auto bg-white shadow-md rounded-lg p-4 sm:p-6 overflow-hidden">
            <div>
                <a href="<?php echo e(\App\Filament\Resources\RiwayatMaintenances\RiwayatMaintenanceResource::getUrl('create') . '?perangkat_id=' . $perangkat->id); ?> "
            ...
            <div class="border-b-4 border-b-green-400 pb-4 mb-6">
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-900"><?php echo e($perangkat->nama_perangkat); ?></h1>
                <p class="text-lg text-gray-600"><?php echo e($perangkat->nomor_inventaris); ?></p>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 mb-6">
                <div>
                    <span class="text-sm font-medium text-gray-500">Jenis</span>
                    <p class="text-base text-gray-900"><?php echo e($perangkat->jenis?->nama_jenis ?? 'N/A'); ?></p>
                </div>
                <div>
                    <span class="text-sm font-medium text-gray-500">Tipe/Merek</span>
                    <p class="text-base text-gray-900"><?php echo e($perangkat->tipe ?? 'N/A'); ?></p>
                </div>
                <div>
                    <span class="text-sm font-medium text-gray-500">Lokasi</span>
                    <p class="text-base text-gray-900"><?php echo e($perangkat->lokasi?->nama_lokasi ?? 'N/A'); ?></p>
                </div>
                <div>
                    <span class="text-sm font-medium text-gray-500">Status</span>
                    <p>
                        <span class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20">
                            <?php echo e($perangkat->status?->nama_status ?? 'N/A'); ?>
                ...
                <div>
                    ...
                    <p>
                        <span class="inline-flex items-center rounded-md bg-blue-50 px-2 py-1 text-xs font-medium text-blue-700 ring-1 ring-inset ring-blue-600/20">
                            <?php echo e($perangkat->kondisi?->nama_kondisi ?? 'N/A'); ?>
            ...
            <div class="space-y-4 border-green-400 shadow-md border rounded-lg">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $perangkat->riwayatMaintenances->sortByDesc('tanggal_maintenance'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div x-data="{ expanded: false }" class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    <p :class="!expanded ? 'line-clamp-1' : ''" class="font-semibold text-gray-800">
                        <?php echo e($history->deskripsi); ?>

                    </p>
                    <div class="flex flex-wrap gap-2 items-center justify-between mt-2">
                        <div class="flex flex-col gap-2 w-full">
                            <span class="text-sm text-gray-500">
                                <?php echo e(optional($history->tanggal_maintenance)->format('d M Y') ?? $history->created_at->format('d M Y')); ?>
                            ...
                            <a href="<?php echo e(route('public.maintenance.show', $history)); ?>"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($history->harga): ?>
                    <div class="mt-2 text-sm font-medium text-gray-900">
                        Rp <?php echo e(number_format($history->harga, 0, ',', '.')); ?>
...
</html><?php /**PATH D:\Informatika V2\INVENTARIS MIPA\inventaris_rt3\resources\views/public/perangkat-detail.blade.php ENDPATH**/ ?>